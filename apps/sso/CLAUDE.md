# CLAUDE.md — Taskflow SSO Platform

This file provides guidance to Claude Code (claude.ai/code) when working with this codebase.

## Project Overview

**Taskflow SSO** is a centralized OAuth 2.1 / OIDC authentication server serving multiple Taskflow applications. Built with Better Auth, Next.js 15, Drizzle ORM, and Neon Postgres.
...
- **Taskflow SSO Dashboard** - Admin interface (first-party)
...
pnpm seed:prod             # Production: Taskflow + AI Native only
