...
export function Toast({ message, type = "success", duration = 5000, onClose }: ToastProps) {
  ...
  const styles = {
    ...
    info: {
      container: "bg-gradient-to-br from-taskflow-500 via-taskflow-500 to-violet-600",
      glow: "shadow-taskflow-500/40",
      particles: "from-taskflow-300/60 to-violet-400/60",
      icon: (
        <svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
