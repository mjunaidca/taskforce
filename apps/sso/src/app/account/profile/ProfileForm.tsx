...
export default function ProfileForm({
  ...
  const inputClass = "w-full px-4 py-3.5 border-2 border-slate-200 rounded-xl focus:border-taskflow-500 focus:ring-4 focus:ring-taskflow-500/10 transition-all duration-200 bg-white hover:border-slate-300";
  ...
  return (
    <>
        ...
        <div className="space-y-3">
          ...
          <div className="relative">
            ...
            <div className="absolute right-4 top-1/2 -translate-y-1/2">
              <svg className="w-5 h-5 text-taskflow-600" fill="none" stroke="currentColor" viewBox="0 0 24 24">
      ...
      <section className="space-y-5">
        ...
        {/* Contact Subsection */}
        <div className="pt-2">
          <p className="text-xs font-semibold text-taskflow-600 uppercase tracking-wider mb-4">Contact</p>
        </div>
        <div className="space-y-3">
        ...
        {/* Identity Subsection */}
        <div className="pt-2">
          <p className="text-xs font-semibold text-taskflow-600 uppercase tracking-wider mb-4">Identity</p>
        </div>
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-5">
          <div className="space-y-3">
        ...
        {/* Location Subsection */}
        <div className="pt-2">
          <p className="text-xs font-semibold text-taskflow-600 uppercase tracking-wider mb-4">Location</p>
        </div>
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-5">
          <div className="space-y-3">
            <label className="block text-sm font-semibold text-slate-700">
        ...
        <p className="text-xs text-slate-500 leading-relaxed flex items-center gap-1.5 bg-taskflow-50/50 p-3 rounded-lg border border-taskflow-100">
          <svg className="w-4 h-4 text-taskflow-600 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M13 16h-1v-4h-1m1-4h.01M21 12a9 9 0 11-18 0 9 9 0 0118 0z" />
          </svg>
          <span>All additional information fields are optional and help personalize your experience across Taskflow platforms.</span>
        </p>
      </section>
      ...
      <div className="pt-4 flex gap-4 border-t-2 border-slate-200">
        <button
          type="submit"
          disabled={loading}
          className="flex-1 relative py-4 px-6 bg-gradient-to-r from-taskflow-600 to-taskflow-700 text-white font-bold rounded-xl shadow-lg shadow-taskflow-500/30 hover:shadow-xl hover:shadow-taskflow-500/40 hover:scale-[1.02] focus:outline-none focus:ring-4 focus:ring-taskflow-500/50 transition-all duration-200 disabled:opacity-50 disabled:cursor-not-allowed disabled:hover:scale-100 overflow-hidden group"
        >
          {loading ? (
            ...
            <>
              ...
              <div className="absolute inset-0 bg-gradient-to-r from-taskflow-700 to-taskflow-800 opacity-0 group-hover:opacity-100 transition-opacity" />
            </>
          )}
        </button>
      </div>
