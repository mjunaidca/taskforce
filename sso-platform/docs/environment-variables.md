...
| Variable | Purpose | Example | Required |
|----------|---------|---------|----------|
| `ALLOWED_ORIGINS` | Comma-separated allowed origins | `http://localhost:3000,https://taskflow.org` | ✅ Yes |

### Branding (White-Label Support)

| Variable | Purpose | Example | Default |
|----------|---------|---------|---------|
| `NEXT_PUBLIC_APP_NAME` | Application name shown in UI | `Taskflow SSO` | `Taskflow SSO` |
| `NEXT_PUBLIC_APP_DESCRIPTION` | App description in header | `Secure Single Sign-On` | `Secure Single Sign-On` |
| `NEXT_PUBLIC_ORG_NAME` | Organization name in emails/footer | `Taskflow` | `Taskflow` |
...
### ❓ Why is `TASKFLOW_SSO_REDIRECT_URLS` not implemented?
...
# CORS
ALLOWED_ORIGINS=http://localhost:3000,https://taskflow.org
