...
{
  "key": "tf_lniZlImAbPDnAWURoySDCKNVDfiPuRXxkNNYLCBpXTKHitxlUXqcKtWuaFMWIbqI",
...
curl -X POST http://localhost:3001/api/api-key/verify \
  -H "Content-Type: application/json" \
  -d '{"key": "tf_lniZlImAbPDnAWURoySDCKNVDfiPuRXxkNNYLCBpXTKHitxlUXqcKtWuaFMWIbqI"}'
