...
# Production setup (only Taskflow SSO + AI Native, skips RoboLearn)
pnpm run seed:prod
```
...
|------|---------|--------------|----------|
| **Development** (`seed:setup`) | • RoboLearn<br>• Taskflow SSO<br>• AI Native | ✅ Test org | Local development & testing |
| **Production** (`seed:prod`) | • Taskflow SSO<br>• AI Native | ❌ None | Production deployment |
