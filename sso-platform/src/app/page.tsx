      ...
      <div className="min-h-screen flex items-center justify-center py-12 px-4 relative overflow-hidden">
        ...
        <div className="max-w-lg w-full relative z-10">
          ...
          <div className="glass-effect rounded-2xl shadow-2xl shadow-taskflow-500/10 p-8 md:p-10 animate-in scale-in">
            {/* Status Badge */}
            <div className="inline-flex items-center gap-2 px-3 py-1.5 rounded-full bg-taskflow-50 border border-taskflow-200 mb-6">
              <div className="w-2 h-2 rounded-full bg-taskflow-500 animate-pulse" />
              <span className="text-xs font-semibold text-taskflow-700 tracking-wide uppercase">
                Authenticated
              </span>
            </div>
            ...
            {/* Session Info */}
            <div className="bg-gradient-to-br from-taskflow-50 to-slate-50 rounded-xl p-5 mb-8 border border-taskflow-100">
              <div className="flex items-start gap-4">
                <div className="w-10 h-10 rounded-lg bg-gradient-to-br from-taskflow-500 to-taskflow-600 flex items-center justify-center flex-shrink-0 shadow-md shadow-taskflow-500/30">
                  <svg
            ...
            <div className="space-y-3">
              <a
                href={continueUrl}
                className="block w-full py-3.5 px-6 rounded-xl text-sm font-semibold text-white bg-gradient-to-r from-taskflow-500 to-taskflow-600 shadow-lg shadow-taskflow-500/30 text-center transition-all duration-200 hover:shadow-xl hover:shadow-taskflow-500/40 hover:-translate-y-0.5"
              >
